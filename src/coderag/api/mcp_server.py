...
consulta, lectura e ingesta seleccionadas; el resto de operaciones queda fuera
mediante un filtro ``include_operations`` (default-deny). Coexiste con la API
REST en el mismo proceso/puerto.
"""
...
# no listado aquí (admin/reset, ingesta directa, endpoints TDM, health) queda
# fuera del servidor MCP.
