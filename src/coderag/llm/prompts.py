...
def build_answer_prompt(question: str, context: str) -> str:
    ...
    return (
        "Responde solo con evidencia del contexto y cuando debas citar las fuentes usa nombres de documentos o archivos. "
        "No cites identificadores tecnicos de chunk (por ejemplo Chunk, c123, chunk_id). "
